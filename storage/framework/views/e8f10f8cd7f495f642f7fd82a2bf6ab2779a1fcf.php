...
<head>
    ...
    <?php $__env->startSection('styles'); ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('themes/purposeTheme/assets/css/toast.css')); ?>"/>
...
<!-- Whatsapp Goes -->
<a href="https://api.whatsapp.com/send?phone=<?php echo e($settings->whatsapp); ?>&text= Hello <?php echo e($settings->site_name); ?>" id="WhatsAppBtnDesktop" target="_blank" class="anchor-btn" lang="en">
    <div id="capitol-callback">
        <div class="cpt-circle"></div>
        <div class="cpt-circle-fill"></div>
        <img src="<?php echo e(asset('themes/purposeTheme/assets/img/whatsapp.png')); ?>" width="100%">
    </div>
</a>
