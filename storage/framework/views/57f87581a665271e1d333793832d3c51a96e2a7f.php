...
} elseif ($_instance->childHasBeenRendered('4tnQIVg')) {
    $componentId = $_instance->getRenderedChildComponentId('4tnQIVg');
    $componentTag = $_instance->getRenderedChildComponentTagName('4tnQIVg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4tnQIVg');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('4tnQIVg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /Users/7thpriest/Codes/PHP Projects/Rough/mi360/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>