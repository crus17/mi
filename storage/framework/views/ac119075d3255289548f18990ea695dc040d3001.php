                ...
                <div class="col-lg-9">
                    <div class="border-0 rounded card">
                        <div class="card-body">
                            ...
                            <p class="text-muted">Email: <?php echo e($settings->contact_email); ?></p>
                            ...
                            <p class="mt-4 text-muted">If you decide to terminate your account, you may do so by
                                emailing us at <?php echo e($settings->contact_email); ?>. If you terminate your account, please be
                                aware
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/7thpriest/Codes/PHP Projects/Rough/mi360/resources/views/home/terms.blade.php ENDPATH**/ ?>